...
export default AdminSiswa = ({navigation}) => {
          ...
          [
            {
              ...
              onPress: () => {
                ...
                .catch(err => navigation.push('AdminSiswa'))
              },
            },
            {
              text: "Tidak",
    ...
    return <TableAdmin title={title} dataTable={dataTable} onNewPage={() => navigation.navigate('NewStudent')} />
